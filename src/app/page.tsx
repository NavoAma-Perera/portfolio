...
function AnimatedBackground() {
  ...
  useEffect(() => {
    ...
    const updateCanvasSize = () => {
      ...
      const particleCount = canvas.width > 768 ? 100 : 60
...
export default function Home() {
  ...
  className="mt-20 px-8 py-4 text-base md:text-lg rounded-3xl border-2 border-cyan-400 text-cyan-400 bg-white/10 backdrop-blur-md hover:border-yellow-400 hover:text-yellow-400 transition-all duration-300 cursor-pointer z-30 font-semibold"
  aria-label="Explore me page"
>
  Explore me
</button>
